...
//
// API "my-inventory": health TestHelpers
//
// Command:
// $ goagen
...
// HealthHealthInternalServerError runs the method Health of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func HealthHealthInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.HealthController) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
