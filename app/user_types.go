...
func (ut *authenticatePayload) Validate() (err error) {
	...
	if ut.Login != nil {
		if utf8.RuneCountInString(*ut.Login) < 5 {
			err = goa.MergeErrors(err, goa.InvalidLengthError(`response.login`, *ut.Login, utf8.RuneCountInString(*ut.Login), 5, true))
		}
	}
	if ut.Password != nil {
		if utf8.RuneCountInString(*ut.Password) < 1 {
			err = goa.MergeErrors(err, goa.InvalidLengthError(`response.password`, *ut.Password, utf8.RuneCountInString(*ut.Password), 1, true))
		}
	}
	if ut.Password != nil {
		if utf8.RuneCountInString(*ut.Password) > 32 {
			err = goa.MergeErrors(err, goa.InvalidLengthError(`response.password`, *ut.Password, utf8.RuneCountInString(*ut.Password), 32, false))
		}
	}
	return
}
...
func (ut *userCreatePayload) Validate() (err error) {
	...
	if ut.Nickname != nil {
		if utf8.RuneCountInString(*ut.Nickname) < 1 {
			err = goa.MergeErrors(err, goa.InvalidLengthError(`response.nickname`, *ut.Nickname, utf8.RuneCountInString(*ut.Nickname), 1, true))
		}
	}
	if ut.Nickname != nil {
		if utf8.RuneCountInString(*ut.Nickname) > 32 {
			err = goa.MergeErrors(err, goa.InvalidLengthError(`response.nickname`, *ut.Nickname, utf8.RuneCountInString(*ut.Nickname), 32, false))
		}
	}
	if ut.Password != nil {
		if utf8.RuneCountInString(*ut.Password) < 1 {
