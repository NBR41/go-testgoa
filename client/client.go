...
// Client is the my-inventory service client.
type Client struct {
	*goaclient.Client
	JWTSecSigner goaclient.Signer
...
// SetJWTSecSigner sets the request signer for the JWTSec security scheme.
func (c *Client) SetJWTSecSigner(signer goaclient.Signer) {
	c.JWTSecSigner = signer
}
